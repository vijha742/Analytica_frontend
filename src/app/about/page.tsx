        ...
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
          ...
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-slate-600 dark:text-slate-300 max-w-3xl mx-auto leading-relaxed">
              A comprehensive GitHub analytics platform designed to help
              developers track, analyze, and improve their coding journey
              through insightful data visualization and peer comparison.
            </p>
          </div>
            ...
            <div className="lg:col-span-2 space-y-8">
              ...
              <Card className="p-8 backdrop-blur-sm bg-white/70 dark:bg-slate-800/70 border-slate-200/50 dark:border-slate-700/50 shadow-xl">
                ...
                <p className="text-slate-600 dark:text-slate-300 leading-relaxed mb-4">
                  We believe in empowering developers through data-driven
                  insights. Analytica transforms raw GitHub activity into
                  meaningful metrics that help you understand your coding
                  patterns, identify areas for improvement, and celebrate your
                  achievements.
                </p>
                <p className="text-slate-600 dark:text-slate-300 leading-relaxed">
                  Whether you&apos;re a beginner looking to track your progress
                  or an experienced developer wanting to optimize your workflow,
                  Analytica provides the tools and insights you need to excel in
                  your coding journey.
                </p>
              </Card>
                    ...
                    <div className="flex items-start space-x-3">
                      ...
                      <div>
                        ...
                        <p className="text-sm text-slate-600 dark:text-slate-300">
                          Monitor commits, pull requests, and contributions
                        </p>
                      </div>
                    </div>
                    <div className="flex items-start space-x-3">
                  ...
                  <div className="space-y-4">
                    ...
                    <div className="flex items-start space-x-3">
                      ...
                      <div>
                        ...
                        <p className="text-sm text-slate-600 dark:text-slate-300">
                          Beautiful, responsive data visualization
                        </p>
                      </div>
                    </div>
                    <div className="flex items-start space-x-3">
                      ...
                      <div>
                        ...
                        <p className="text-sm text-slate-600 dark:text-slate-300">
                          Stay updated with live GitHub data
                        </p>
                      </div>
                    </div>
                  </div>
