        ...
        <div className="space-y-4 max-w-xl mx-auto bg-gray-900 absolute rounded-xl shadow-lg p-4 border border-gray-800 flex flex-col relative transition-colors">
            ...
            <div className="flex items-center space-x-4">
                ...
                <div className="flex-1 min-w-0">
                    ...
                    <p className="text-indigo-400 font-medium truncate">@{user.githubUsername}</p>
                    {user.bio ? (
                ...
                <div className="flex flex-col mt-2" >
                    ...
                    <button
                        className={`px-3 py-1 flex justify-center items-center rounded-md  mt-4 bg-gray-200 text-black text-sm font-semibold shadow transition-colors`}
            ...
            <div className="mt-2 grid grid-cols-3 gap-2 bg-gray-800/70 rounded-lg p-2">
                <div className="flex flex-col items-center">
                    <span className="font-semibold text-white text-sm">{user.followersCount || 0}</span>
                    <span className="text-xs text-gray-400">Followers</span>
                </div>
                <div className="flex flex-col items-center">
                    <span className="font-semibold text-white text-sm">{user.followingCount || 0}</span>
                    <span className="text-xs text-gray-400">Following</span>
                </div>
                <div className="flex flex-col items-center">
                    <span className="font-semibold text-white text-sm">{user.publicReposCount || 0}</span>
