      ...
      <div className="container mx-auto flex flex-col items-center text-center lg:items-center lg:text-center">
        <div className="text-center max-w-2xl mx-auto mb-16">
          ...
          <p className="text-muted-foreground">
            Experience Analytica GitHub in your preferred theme, optimized for all times of day.
          </p>
        </div>
        ...
        <div className="max-w-5xl mx-auto">
          ...
          <div className="relative mx-auto rounded-xl overflow-hidden shadow-lg border">
            <div className={`${activeMode === "dark" ? "bg-gray-900" : "bg-white"} p-4`}>
              <div className="flex items-center justify-between mb-4">
                <div className="flex items-center gap-2">
                  <Github className={`h-6 w-6 ${activeMode === "dark" ? "text-white" : "text-black"}`} />
                  <span className={`font-bold ${activeMode === "dark" ? "text-white" : "text-black"}`}>
                    Analytica GitHub
                  </span>
                </div>
                <div className="flex items-center gap-2">
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                  ...
                  <div className="space-y-2">
                    {[
                      ...
                      <div key={i} className="flex justify-between">
                        <span className={activeMode === "dark" ? "text-gray-400" : "text-gray-600"}>
                          {stat.label}
                        </span>
                ...
                <div className={`rounded-lg p-4 col-span-2 ${
                  ...
                  <div className="flex justify-between mt-2 text-xs">
                    <span className={activeMode === "dark" ? "text-gray-400" : "text-gray-600"}>Jan</span>
                    <span className={activeMode === "dark" ? "text-gray-400" : "text-gray-600"}>Dec</span>
                  </div>
                </div>
              </div>
            </div>
