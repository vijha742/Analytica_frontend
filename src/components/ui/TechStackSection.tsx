...
export default function TechStackSection() {
  const technologies = [
    ...
    { name: "Neon", logo: "https://logosandtypes.com/wp-content/uploads/2024/07/Neon-Tech.png" },
    { name: "GitHub GraphQL API", logo: "https://img.icons8.com/fluency/48/github.png" },
  ];
      ...
      <div className="container mx-auto text-center ">
        <div className="text-center max-w-2xl mx-auto mb-16">
          ...
          <p className="text-muted-foreground">
            Built with modern technologies for optimal performance, security, and developer experience.
          </p>
        </div>
