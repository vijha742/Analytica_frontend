...
interface TechnicalProfileLanguage {
  name: string;
  category: string;
...
interface DashboardTechnicalTabProps {
  technicalProfile: {
    languageSpecificFields: TechnicalProfileLanguage[];
  };
  developerImpactMetrics: DashboardProfileMetrics;
  repositoryAnalytics: RepositoryAnalytics;
}

export function DashboardTechnicalTab({ 
  technicalProfile, 
